    ...
    <div className="md:p-20 w-full h-full">
      ...
      <div className="flex justify-around items-center  bg-white">
        ...
        <div className="p-2 flex  gap-x-5">
          ...
          <button className="font-semibold md:text-xl"><Link to="/login">LOGIN</Link></button>
          <button className="font-semibold md:text-xl"><Link to="/register">REGISTER</Link></button>
          <MenuOutlined onClick={() => setIsOpen(!isOpen)} className="md:hidden font-semibold text-xl bg-white p-2 shadow-md shadow-gray-400 rounded-xl h-10"/>
        </div>
      </div>
      ...
      <div className="p-4 -mt-15 "> {/* Adjust the padding-top to match the navbar height */}
        <Outlet />
      </div>
